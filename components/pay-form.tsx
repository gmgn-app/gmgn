...
export default function PayForm() {
  ...
  const [sendingAmount, setSendingAmount] = useState(searchParams.get("sendingAmount") || "");
  const [receivingAddress, setReceivingAddress] = useState(searchParams.get("receivingAddress") || "");
  const [transactionMemo, setTransactionMemo] = useState(fromHex(searchParams.get("transactionMemo") as `0x${string}`, 'string') || "");
