...
### Recommended testnet
- We recommend using the [Kaia Kairos](https://kaia.io/) testnet for learning purpose. It is a fast and free testnet that is compatible with the Ethereum network. Also, there is a faucet available to get free testnet tokens.
